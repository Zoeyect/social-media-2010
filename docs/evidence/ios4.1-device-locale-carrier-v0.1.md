...
| --- | --- | --- |
| Start instant | `2010-10-20T00:02:00-07:00` | **CURRENT canonical narrative value** |
...
The current U.S. session runs from 12:02 AM to 12:17 AM on October 20, 2010. The visible Lock Screen and Status Bar text is `12:02` through `12:17`, with no 24-hour display. Separate surface formatters may still prevent an internal en-US day period from forcing unwanted visible `AM` text.
