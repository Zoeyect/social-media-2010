...
["jack-birthday-02", "BH02.png", "jack", "facebook", "2010-08-03T13:08:00-07:00", "birthday", "visible"],
  ...
  assert.match(deviceCssSource, /\.instagram-profile-avatar,\.instagram-profile-avatar-placeholder \{ width: 74px; height: 74px;/, "player and known-account Profile avatars must retain the approved 74pt geometry");
  assert.match(deviceCssSource, /\.instagram-profile-stats > div \{[^}]*height: 46px;[^}]*background: linear-gradient\(#5f8db3,#38658c\)/, "Profile must retain the approved 46pt steel-blue statistic blocks");
