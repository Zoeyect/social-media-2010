...
["jack-birthday-02", "BH02.png", "jack", "facebook", "2010-08-03T13:08:00-07:00", "birthday", "visible"],
  ...
  assert.match(facebookContainerSource, /surface === "feed" \? \[commentLabel, likeLabel\] : \[likeLabel, commentLabel\]/, "News Feed engagement summaries must order comments before likes without changing Wall ordering");
