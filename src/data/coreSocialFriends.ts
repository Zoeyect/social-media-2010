...
export const CORE_SOCIAL_CHARACTERS = Object.freeze({
  katie: Object.freeze({ id: "katie", displayName: "Katie Dawson", initials: "K", category: "core-friend", lifeStage: "young-social-circle", fictional: true, classification: "CURATED FICTIONAL" }),
  matt: Object.freeze({ id: "matt", displayName: "Matt Ricci", initials: "M", category: "core-friend", lifeStage: "young-social-circle", fictional: true, classification: "CURATED FICTIONAL" }),
  alex: Object.freeze({ id: "alex", displayName: "Alex Wong", initials: "A", category: "core-friend", lifeStage: "young-social-circle", fictional: true, classification: "CURATED FICTIONAL" }),
  chris: Object.freeze({ id: "chris", displayName: "Chris Morgan", initials: "C", category: "core-friend", lifeStage: "young-social-circle", fictional: true, classification: "CURATED FICTIONAL" }),
  jay: Object.freeze({ id: "jay", displayName: "Jay Diaz", initials: "J", category: "core-friend", lifeStage: "young-social-circle", fictional: true, classification: "CURATED FICTIONAL" }),
  june: Object.freeze({ id: "june", displayName: "June Park", initials: "J", category: "narrative-contact", lifeStage: "young-social-circle", fictional: true, classification: "CURATED FICTIONAL", socialHandles: Object.freeze({ instagram: "junepark" }) }),
  jack: Object.freeze({ id: "jack", displayName: "Jack Keller", initials: "J", category: "narrative-contact", lifeStage: "young-social-circle", fictional: true, classification: "CURATED FICTIONAL" }),
  ben: Object.freeze({ id: "ben", displayName: "Ben Dawson", initials: "B", category: "extended-friend", lifeStage: "working-adult", fictional: true, classification: "CURATED FICTIONAL" }),
  luca: Object.freeze({ id: "luca", displayName: "Luca Bennett", initials: "L", category: "extended-friend", lifeStage: "working-adult", fictional: true, classification: "CURATED FICTIONAL" }),
