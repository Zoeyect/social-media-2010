import { SESSION_START_ISO, SESSION_DURATION_MS } from "../state/deviceMachine";
...
export const PUBLIC_TWITTER_SIMULATED_END_MS = PUBLIC_TWITTER_SIMULATED_START_MS + SESSION_DURATION_MS;
