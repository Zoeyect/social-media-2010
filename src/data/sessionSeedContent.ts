...
Object.freeze({ id: "jack-movie", friendId: CORE_SOCIAL_CHARACTERS.jack.id, author: CORE_SOCIAL_CHARACTERS.jack.displayName, text: "That movie was better than I expected.", timestamp: "9:52 PM", createdAt: "2010-10-19T21:52:00-07:00", kind: "status" as const, visibility: "friends" as const, profileWallEligible: true, origin: "seed" as const }),
...
Object.freeze({ id: "jack-profile-picture-update", friendId: CORE_SOCIAL_CHARACTERS.jack.id, author: CORE_SOCIAL_CHARACTERS.jack.displayName, text: "updated his profile picture.", timestamp: "Sep 5", createdAt: "2010-09-05T18:00:00-07:00", kind: "photo" as const, visibility: "custom" as const, customAudienceIncludesUser: false, mediaId: "jack-profile-picture" as const, profileWallEligible: true, origin: "seed" as const }),
      ...
      Object.freeze({ id: "alex-jacks-party-friday", friendId: CORE_SOCIAL_CHARACTERS.alex.id, author: CORE_SOCIAL_CHARACTERS.alex.displayName, text: "anyone going to jack's party friday?", timestamp: "9:47 PM", createdAt: "2010-10-19T21:47:00-07:00", kind: "status" as const, visibility: "friends-of-friends" as const, origin: "seed" as const }),
      Object.freeze({ id: "katie-coffee", friendId: CORE_SOCIAL_FRIENDS.katie.id, author: CORE_SOCIAL_FRIENDS.katie.displayName, text: "likes a coffee shop downtown.", timestamp: "9:41 PM", createdAt: "2010-10-19T21:41:00-07:00", kind: "activity" as const, visibility: "friends" as const, origin: "seed" as const }),
      Object.freeze({ id: "jay-reading", friendId: CORE_SOCIAL_FRIENDS.jay.id, author: CORE_SOCIAL_FRIENDS.jay.displayName, text: "One more chapter before bed.", timestamp: "9:33 PM", createdAt: "2010-10-19T21:33:00-07:00", kind: "status" as const, visibility: "friends" as const, origin: "seed" as const }),
      Object.freeze({ id: "luca-pickup-basketball-photos", friendId: CORE_SOCIAL_CHARACTERS.luca.id, author: CORE_SOCIAL_CHARACTERS.luca.displayName, text: `added ${LUCA_PICKUP_BASKETBALL_MEDIA_IDS.length} new photos from pickup basketball.`, timestamp: "9:28 PM", createdAt: "2010-10-19T21:28:00-07:00", kind: "album" as const, visibility: "friends" as const, mediaId: LUCA_PICKUP_BASKETBALL_MEDIA_IDS[0], mediaIds: LUCA_PICKUP_BASKETBALL_MEDIA_IDS, albumTitle: "Pickup Basketball", photoCount: LUCA_PICKUP_BASKETBALL_MEDIA_IDS.length, relatedCharacterIds: Object.freeze([CORE_SOCIAL_CHARACTERS.chris.id]), tagUiStatus: "HOLD" as const, origin: "seed" as const }),
      Object.freeze({ id: "luca-profile-picture-current", friendId: CORE_SOCIAL_CHARACTERS.luca.id, author: CORE_SOCIAL_CHARACTERS.luca.displayName, text: "updated his profile picture.", timestamp: "8:00 PM", createdAt: "2010-10-19T20:00:00-07:00", kind: "photo" as const, visibility: "custom" as const, customAudienceIncludesUser: false, mediaId: "luca-profile-picture" as const, albumTitle: "Profile Pictures", profileWallEligible: true, origin: "seed" as const }),
      Object.freeze({ id: "luca-main-street-diner-checkin", friendId: CORE_SOCIAL_CHARACTERS.luca.id, author: CORE_SOCIAL_CHARACTERS.luca.displayName, text: `is at ${MAIN_STREET_DINER_VENUE.name}.`, timestamp: "9:44 PM", createdAt: "2010-10-19T21:44:00-07:00", kind: "checkin" as const, visibility: "friends" as const, venueId: MAIN_STREET_DINER_VENUE.id, origin: "seed" as const }),
    ...
    inbox: Object.freeze([
      Object.freeze({ id: "katie-tomorrow", friendId: CORE_SOCIAL_FRIENDS.katie.id, sender: CORE_SOCIAL_FRIENDS.katie.displayName, preview: "see you tomorrow", timestamp: "9:14 PM", status: "read" as const, origin: "seed" as const }),
  ...
  twitter: Object.freeze([
    Object.freeze({ id: "still-awake", displayName: "June", text: "anyone still awake?", timestamp: "9:58 PM", timestampProvenance: "CURATED" as const, contentType: "ordinary" as const, contentProvenance: "CURATED" as const, origin: "seed" as const }),
    Object.freeze({
    ...
    Object.freeze({ id: "dana-office-deck", displayName: "Dana", text: "still at the office. this deck is never going to end", timestamp: "9:49 PM", timestampProvenance: "CURATED" as const, contentType: "work-life" as const, contentProvenance: "CURATED" as const, origin: "seed" as const }),
    Object.freeze({ id: "late-night-matt", friendId: CORE_SOCIAL_CHARACTERS.matt.id, displayName: CORE_SOCIAL_CHARACTERS.matt.displayName, text: "can't sleep", timestamp: "9:41 PM", timestampProvenance: "CURATED" as const, contentType: "ordinary" as const, contentProvenance: "CURATED" as const, origin: "seed" as const }),
    Object.freeze({ id: "kanye-discussion", displayName: "Mia", text: "why is everyone talking about Kanye tonight", timestamp: "9:26 PM", timestampProvenance: "CURATED" as const, contentType: "celebrity-discussion" as const, contentProvenance: "CURATED" as const, origin: "seed" as const }),
    Object.freeze({ id: "marcus-client-approved", displayName: "Marcus", text: "client approved the first version. honestly kind of suspicious", timestamp: "9:09 PM", timestampProvenance: "CURATED" as const, contentType: "work-life" as const, contentProvenance: "CURATED" as const, origin: "seed" as const }),
    Object.freeze({
    ...
    Object.freeze({ id: "apple-event", displayName: "Sam", text: "Apple event tomorrow morning. Might follow the liveblogs.", timestamp: "9:47 PM", timestampProvenance: "CURATED" as const, contentType: "apple-reference" as const, contentProvenance: "CURATED/HOLD" as const, origin: "seed" as const }),
    Object.freeze({ id: "priya-file-typo", displayName: "Priya", text: "sent the file and immediately found a typo. perfect.", timestamp: "9:22 PM", timestampProvenance: "CURATED" as const, contentType: "work-life" as const, contentProvenance: "CURATED" as const, origin: "seed" as const }),
    Object.freeze({ id: "class-tomorrow", displayName: "Jack", text: "class tomorrow and I'm still watching TV", timestamp: "9:05 PM", timestampProvenance: "CURATED" as const, contentType: "ordinary" as const, contentProvenance: "CURATED" as const, origin: "seed" as const }),
  ...
  twitterMentions: Object.freeze([
    Object.freeze({ id: "mention-alex-conan", friendId: CORE_SOCIAL_FRIENDS.alex.id, sender: CORE_SOCIAL_FRIENDS.alex.displayName, textTemplate: "@{handle} look at this lol", timestamp: "9:54 PM", unread: true, linkedTweetId: "historical-conan-jackass-3d", origin: "seed" as const, provenance: "CURATED" as const }),
    Object.freeze({ id: "mention-chris-thing", friendId: CORE_SOCIAL_FRIENDS.chris.id, sender: CORE_SOCIAL_FRIENDS.chris.displayName, textTemplate: "@{handle} did you ever finish that thing?", timestamp: "9:38 PM", unread: false, linkedTweetId: null, origin: "seed" as const, provenance: "CURATED" as const }),
  ]),
  twitterDirectMessages: Object.freeze([
    Object.freeze({ id: "dm-katie", friendId: CORE_SOCIAL_FRIENDS.katie.id, sender: CORE_SOCIAL_FRIENDS.katie.displayName, timestamp: "9:46 PM", unread: true, messages: Object.freeze([Object.freeze({ id: "dm-katie-1", text: "crazy ahaha", linkedTweetId: "historical-conan-jackass-3d", origin: "seed" as const })]), origin: "seed" as const, provenance: "CURATED" as const }),
    Object.freeze({ id: "dm-matt", friendId: CORE_SOCIAL_FRIENDS.matt.id, sender: CORE_SOCIAL_FRIENDS.matt.displayName, timestamp: "9:21 PM", unread: false, messages: Object.freeze([Object.freeze({ id: "dm-matt-1", text: "see you tomorrow", linkedTweetId: null, origin: "seed" as const })]), origin: "seed" as const, provenance: "CURATED" as const }),
  ]),
  ...
  flickr: Object.freeze([
    Object.freeze({ id: "sunset-brooklyn", title: "Evening Streetlight", owner: "flickr.demo", timestamp: "2010-10-19 9:50 PM", comments: Object.freeze(["Nice shot"]), origin: "seed" as const }),
    Object.freeze({ id: "coffee-table", title: "Cup and Notepad", owner: "flickr.demo", timestamp: "2010-10-19 9:20 PM", origin: "seed" as const }),
    Object.freeze({ id: "platform", title: "Platform", owner: "flickr.demo", timestamp: "2010-10-19 8:45 PM", origin: "seed" as const }),
  ]),
  ...
  instagram: Object.freeze({
    ...
    knownAccountPosts: Object.freeze([
      Object.freeze({ id: "june-ig-04" as const, canonicalCharacterId: CORE_SOCIAL_CHARACTERS.june.id, username: CORE_SOCIAL_CHARACTERS.june.socialHandles.instagram, mediaId: "june-ig-04" as const, caption: null, timestamp: "2010-10-19T22:00:00-07:00", status: "visible" as const, classification: "CURATED" as const, origin: "seed" as const }),
