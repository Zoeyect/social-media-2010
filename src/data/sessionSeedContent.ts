...
export const SESSION_SEED_CONTENT = Object.freeze({
  ...
  facebook: Object.freeze({
    feed: Object.freeze([
      Object.freeze({ id: "ben-long-day", friendId: CORE_SOCIAL_CHARACTERS.ben.id, author: CORE_SOCIAL_CHARACTERS.ben.displayName, text: "Long day.", timestamp: "11:58 PM", kind: "status" as const, visibility: "friends" as const, origin: "seed" as const }),
      Object.freeze({ id: "jack-movie", friendId: CORE_SOCIAL_CHARACTERS.jack.id, author: CORE_SOCIAL_CHARACTERS.jack.displayName, text: "That movie was better than I expected.", timestamp: "11:52 PM", kind: "status" as const, visibility: "friends" as const, origin: "seed" as const }),
      ...
      Object.freeze({ id: "katie-coffee", friendId: CORE_SOCIAL_FRIENDS.katie.id, author: CORE_SOCIAL_FRIENDS.katie.displayName, text: "likes a coffee shop downtown.", timestamp: "11:41 PM", kind: "activity" as const, visibility: "friends" as const, origin: "seed" as const }),
      Object.freeze({ id: "jay-reading", friendId: CORE_SOCIAL_FRIENDS.jay.id, author: CORE_SOCIAL_FRIENDS.jay.displayName, text: "One more chapter before bed.", timestamp: "11:33 PM", kind: "status" as const, visibility: "friends" as const, origin: "seed" as const }),
      Object.freeze({ id: "luca-pickup-basketball-photos", friendId: CORE_SOCIAL_CHARACTERS.luca.id, author: CORE_SOCIAL_CHARACTERS.luca.displayName, text: "added 4 new photos from pickup basketball.", timestamp: "10:58 PM", kind: "album" as const, visibility: "friends" as const, mediaId: "chris-luca-basketball" as const, mediaIds: Object.freeze(["chris-luca-basketball"] as const), albumTitle: "Pickup Basketball", photoCount: 4, relatedCharacterIds: Object.freeze([CORE_SOCIAL_CHARACTERS.chris.id]), tagUiStatus: "HOLD" as const, origin: "seed" as const }),
      Object.freeze({ id: "luca-main-street-diner-checkin", friendId: CORE_SOCIAL_CHARACTERS.luca.id, author: CORE_SOCIAL_CHARACTERS.luca.displayName, text: "is at Main Street Diner.", timestamp: "10:44 PM", kind: "checkin" as const, visibility: "friends" as const, origin: "seed" as const }),
