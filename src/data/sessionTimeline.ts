...
export const TWITTER_LIVE_ACTIVITY_POOL: readonly SessionTimelineEventDefinition[] = [
  { id: "twitter-slang-epic-fail", atElapsedSeconds: 75, sourceApp: "twitter", type: "twitterBackgroundTweet", payload: { kind: "twitter-post", post: { id: "slang-epic-fail", displayName: "Ben", text: "tried to make ramen without turning the stove on. epic fail", timestamp: "10:03 PM" } }, deliveryPolicy: "internal", provenanceStatus: "CURATED", languageReference: "PERIOD-EVIDENCE" },
  { id: "twitter-eva-school-tomorrow", atElapsedSeconds: 300, sourceApp: "twitter", type: "twitterBackgroundTweet", payload: { kind: "twitter-post", post: { id: "eva-school-tomorrow", displayName: "Eva", text: "ugh I really don't want to go to school tomorrow", timestamp: "10:07 PM" } }, deliveryPolicy: "internal", provenanceStatus: "CURATED" },
  { id: "twitter-late-night-update", atElapsedSeconds: 390, sourceApp: "twitter", type: "twitterBackgroundTweet", payload: { kind: "twitter-post", post: { id: "late-night-line", displayName: "Mia", text: "Still awake. The diner line is moving slowly.", timestamp: "10:08 PM" } }, deliveryPolicy: "internal", provenanceStatus: "CURATED" },
  { id: "twitter-slang-fml", atElapsedSeconds: 540, sourceApp: "twitter", type: "twitterBackgroundTweet", payload: { kind: "twitter-post", post: { id: "slang-fml", displayName: "Dana", text: "just realized the file i worked on all night is the wrong version. FML", timestamp: "10:11 PM" } }, deliveryPolicy: "internal", provenanceStatus: "CURATED", languageReference: "PERIOD-EVIDENCE" },
  { id: "twitter-nora-homework", atElapsedSeconds: 690, sourceApp: "twitter", type: "twitterBackgroundTweet", payload: { kind: "twitter-post", post: { id: "nora-homework", displayName: "Nora", text: "finally starting the homework I ignored all night", timestamp: "10:13 PM" } }, deliveryPolicy: "internal", provenanceStatus: "CURATED" },
  { id: "twitter-terminal-goodnight-world", atElapsedSeconds: 890, sourceApp: "twitter", type: "twitterBackgroundTweet", payload: { kind: "twitter-post", post: { id: "terminal-goodnight-world", displayName: "Eli", text: "goodnight, world.", timestamp: "10:17 PM" } }, deliveryPolicy: "internal", provenanceStatus: "CURATED", role: "terminal-easter-egg" },
];

export const SESSION_TIMELINE_EVENTS: readonly SessionTimelineEventDefinition[] = [
  { id: "initial-sms-mom-home-yet", atElapsedSeconds: 60, sourceApp: "messages", type: "initialSMS", payload: { kind: "initial-sms", id: "mom-home-yet", sender: "Mom", message: "Home yet?", timestamp: "10:03 PM" }, deliveryPolicy: "notification", provenanceStatus: "CURATED" },
  ...
  { id: "instagram-june-replacement-photo", atElapsedSeconds: 210, sourceApp: "instagram", type: "instagramJunePost", payload: { kind: "instagram-june-post", postId: "june-ig-01", mediaId: "june-ig-01", timestamp: "2010-10-19T22:05:30-07:00" }, deliveryPolicy: "internal", provenanceStatus: "CURATED" },
  ...
  { id: "tumblr-background-post", atElapsedSeconds: 630, sourceApp: "tumblr", type: "tumblrBackgroundPost", payload: { kind: "tumblr-post", post: { id: "late-note", type: "text", blog: "latewatch", title: "Late watch", content: "The city gets quieter this late.", timestamp: "2010-10-19 10:12 PM" } }, deliveryPolicy: "internal", provenanceStatus: "CURATED" },
