...
export const SESSION_TIMELINE_EVENTS: readonly SessionTimelineEventDefinition[] = [
  ...
  { id: "tumblr-background-post", atElapsedSeconds: 630, sourceApp: "tumblr", type: "tumblrBackgroundPost", payload: { kind: "tumblr-post", post: { id: "late-note", type: "text", blog: "latewatch", title: "Late watch", content: "The city gets quieter this late.", timestamp: `${simulatedDeviceDateTime(630 * 1000).toISOString().slice(0, 10)} ${simulatedClock(630 * 1000)}` } }, deliveryPolicy: "internal", provenanceStatus: "CURATED" },
